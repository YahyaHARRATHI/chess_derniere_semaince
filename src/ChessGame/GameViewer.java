...
public class GameViewer extends JPanel {
	...
	/**
	 * Used to Initialize images on the board. (Called whenever game is reset as
	 * well).
	 */
	 ...
	 *            The graphics display input.
	 * @param player
	 *            Player chosen to display pieces.
	 * @param name
	 *            Name of the piece to display.
	 * @param numElements
	 *            Number of how many original pieces start on the board. (i.e.
	 *            There are 8 pawns on a traditional board).
	 */
